...
export const routes: Routes = [
  ...
  { path: 'nearshore-proposal', loadComponent: () => import('./pages/nearshore-proposal/nearshore-proposal').then(m => m.NearshoreProposalPage), data: { lang: 'en' } },
  ...
  { path: 'newsletter', loadComponent: () => import('./pages/newsletter/newsletter').then(m => m.NewsletterPage), data: { lang: 'en' } },
  { path: 'pt/personal-about', loadComponent: () => import('./pages/personal-about/personal-about').then(m => m.PersonalAboutPage), data: { lang: 'pt' } },
  { path: 'pt/nearshore-proposal', loadComponent: () => import('./pages/nearshore-proposal/nearshore-proposal').then(m => m.NearshoreProposalPage), data: { lang: 'pt' } },
  ...
  { path: 'pt/newsletter', loadComponent: () => import('./pages/newsletter/newsletter').then(m => m.NewsletterPage), data: { lang: 'pt' } },
  ...
  { path: 'en/newsletter', redirectTo: 'newsletter', pathMatch: 'full' },
